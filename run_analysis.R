...
setwd("C:/Users/fkalsekar/Documents/R/Getting And Cleaning Data Course/getdata%2Fprojectfiles%2FUCI HAR Dataset/UCI HAR Dataset")
...
#Part 1 - Getting And Cleaning datasets course
...
#Organizing and combining raw data sets into one
...
#Part 2 - Extracting the measurements on the mean and standard deviation for each measurement
...
#Part 3 - Descriptive activity names to name the activities in the data set
...
#Part 4 - Labelling the data set with descriptive activity names
